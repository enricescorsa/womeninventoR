...
The goal of the womeninventoR package is to share a patent data set of women inventors for its analysis within R. 
...
The data set contains nearly 400.000 granted patents by women inventors in the US within 2016 and 2020.
...
The womeninventoR package allows you to load the ´womeninventorpatents´  data set and analyse it.
